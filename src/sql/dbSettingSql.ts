class query {
  ...
  invIndex (): string {
    let stringQuery: string = " create unique index idx_ivt_name on t_inventory(name) ";
    return stringQuery
  }
  ...
  hostIndex (): string {
    let stringQuery: string = " create unique index idx_hst_name on t_hosts(name) ";
    return stringQuery
  }
